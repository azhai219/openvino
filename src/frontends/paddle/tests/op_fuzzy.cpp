...
static const std::vector<std::string> models{
	...
	std::string("dequantize_linear_per_layer_static/dequantize_linear_per_layer_static.pdmodel"),
    std::string("dequantize_linear_per_layer_dynamic/dequantize_linear_per_layer_dynamic.pdmodel"),
    std::string("dequantize_linear_per_channel0_static/dequantize_linear_per_channel0_static.pdmodel"),
    std::string("dequantize_linear_per_channel1_static/dequantize_linear_per_channel1_static.pdmodel"),
    std::string("dropout"),
	...
	// std::string("quantize_linear_dynamic/quantize_linear_dynamic.pdmodel"),
    // std::string("quantize_linear_static/quantize_linear_static.pdmodel"),
	std::string("quantize_linear_dynamic"),
    std::string("quantize_linear_static"),
    std::string("range0"),
    std::string("range1"),
    std::string("range2"),
